...
def ver_publicacion(publicacion_id):
    with conectar_bd() as conexion:
        ...
        cursor.execute('SELECT * FROM comentarios WHERE publicacion_id = ? ORDER BY id', (publicacion_id,))
        comentarios = cursor.fetchall()

    return render_template('publicacion.html', publicacion=publicacion, comentarios=comentarios if comentarios else [])
