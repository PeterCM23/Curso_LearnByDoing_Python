...
def ver_tareas(lista_tareas):
        ...
        if not lista_tareas:
            ...
            for i, tarea in enumerate(lista_tareas, 1):
                ...
                fecha_vencimiento = f"Fecha de vencimiento: {tarea.fecha_vencimiento.strftime('%Y-%m-%d')}" if tarea.fecha_vencimiento else "Sin fecha de vencimiento"
                print(f"{i}. {tarea.descripcion} - {estado} - {recordatorio} - {fecha_vencimiento}")
...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            recordatorio = input("Ingrese el recordatorio(opcional):")
            ...
            agregar_tarea(lista_tareas, descripcion, recordatorio, fecha_vencimiento)
