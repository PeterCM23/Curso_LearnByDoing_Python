...
def marcar_completada(lista_tareas,numero_tarea):
        ...
        if 1 <= numero_tarea <= len(lista_tareas):
            ...
            print("Numero de tarea invalido.")def eliminar_tarea(lista_tareas, numero_tarea):
    ...
    def main():
        ...
        while True:
            ...
            if opcion == "1":
                ...
                Tarea.agregar_tarea(lista_tareas, descripcion)

            elif opcion == "2":
                Tarea.ver_tareas(lista_tareas)

            elif opcion == "3":
                Tarea.ver_tareas(lista_tareas)
                numero_tarea = int(input("Ingrese el numero de la tarea completada:"))
                Tarea.marcar_completada(lista_tareas, numero_tarea)

            elif opcion == "4":
                Tarea.ver_tareas(lista_tareas)
                numero_tarea = int(input("Ingrese el numero de la tarea a eliminar:"))
                Tarea.eliminar_tarea(lista_tareas, numero_tarea)
