    ...
    def jugar():
        ...
        while True:
            ...
            if opcion == "1":
                ...
                respuesta_usuario = input("Ingresa el nu,ero de la respuesta correcta: ")
                
                if respuesta_usuario == str(pregunta.opciones.index(pregunta.respuesta_correcta) + 1):
                    print("¡Correcto! Has ganado un punto.")
                else:
                    print(f"Incorrecto. La respuesta correcta")
